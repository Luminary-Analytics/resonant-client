...
from ..engine.model_prompts import LUMI_CLARIFICATION_CONTRACT
...
SPECIALISTS: dict[str, SpecialistProfile] = {
    ...
    NodeSpecialization.REFLECT: SpecialistProfile(
        ...
        system_block=(
            ...
            "- `[chrome]` — drive the browser with the built-in `browser_*` "
            "  tools: `browser_navigate`, `browser_read` (use mode "
            "  'accessibility' to see what is clickable), `browser_click`, "
            "  `browser_type`, and `browser_screenshot`. Chrome starts "
            "  automatically on first use. A user-configured browser MCP is "
            "  also valid. When "
...
def assemble_system_prompt(
    *,
    ...
    parts.append(LUMI_CLARIFICATION_CONTRACT)
