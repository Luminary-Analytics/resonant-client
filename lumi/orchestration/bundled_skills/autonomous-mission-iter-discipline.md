...
- `lumi/gui/autonomous_loop.py` — the daemon's outer loop.
- `lumi/orchestration/specialists.py` — REFLECT's system prompt with the failure-annotation rule.
