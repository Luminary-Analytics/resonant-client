...
class LumiRunCards {
    ...
    _liveRunToolActivity(name, args = {}) {
        ...
        const activities = {
            ...
            codex_file_change: ['Applying Codex file changes', 'Applied Codex file changes'],
            codex_command: [command ? `Running ${command}` : 'Running a Codex command', command ? `Ran ${command}` : 'Ran a Codex command'],
            codex_mcp: ['Using a Codex integration', 'Used a Codex integration'],
            codex_web_search: ['Searching the web with Codex', 'Searched the web with Codex'],
